...
INSERT INTO ViTriLamViec(MaSoViTri, TenViTri)
VALUES 
(2, 'Trưởng phòng kế toán'),
(3, 'Trưởng phòng thiết kế'),
(4, 'Trưởng phòng thi công');
...
where
	n.MaSoChiNhanh=c.MaSoChiNhanh and
	n.MaSoViTri=v.MaSoViTri and
	c.MaSoChiNhanh=p.MaSoChiNhanh and
